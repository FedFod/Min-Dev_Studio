...
#include "MinDivTest.jit.removezeros.cpp"    // need the source of our object so that we can access it
...
SCENARIO("object produces correct output") {
	...
	GIVEN("An instance of our object") {
		...
		test_wrapper<MinDivTest_jit_removezeros> an_instance;
		MinDivTest_jit_removezeros&              my_object = an_instance;
